...
```bash
$ hashcat -m 1000 23d1e086b85cc18587bbc8c33adefe07 /usr/share/wordlists/rockyou.txt
...
...
23d1e086b85cc18587bbc8c33adefe07:memeallme!

Session..........: hashcat
Status...........: Cracked
Hash.Mode........: 1000 (NTLM)
Hash.Target......: 23d1e086b85cc18587bbc8c33adefe07
Time.Started.....: Tue Aug 19 17:00:31 2025 (1 sec)
Time.Estimated...: Tue Aug 19 17:00:32 2025 (0 secs)
Kernel.Feature...: Pure Kernel
Guess.Base.......: File (/usr/share/wordlists/rockyou.txt)
Guess.Queue......: 1/1 (100.00%)
Speed.#1.........:  7342.4 kH/s (0.28ms) @ Accel:1024 Loops:1 Thr:1 Vec:8
Recovered........: 1/1 (100.00%) Digests (total), 1/1 (100.00%) Digests (new)
Progress.........: 5632000/14344385 (39.26%)
Rejected.........: 0/5632000 (0.00%)
Restore.Point....: 5611520/14344385 (39.12%)
Restore.Sub.#1...: Salt:0 Amplifier:0-1 Iteration:0-1
Candidate.Engine.: Device Generator
Candidates.#1....: meri6433 -> mellers72
...
```
...
过滤 HTTP 流量，发现有多条执行命令相关的数据包，逐一分析。

![ciscn_18th_zeroshell_1](./images/ciscn_18th_zeroshell_1.png)

```bash
$ echo "ZmxhZ3s2QzJFMzhEQS1EOEU0LThEODQtNEE0Ri1FMkFCRDA3QTFGM0F9" | base64 -d
...
FLAG：`flag{miscsecure.com:192.168.116.130:443}`
...
![](./images/ciscn_18th_WinFT_3.png)

FLAG：`flag{AES_encryption_algorithm_is_an_excellent_encryption_algorithm}`
...
查找十六进制值 `50 4B 03 04` 或 `http contains "PK"`，共发现两个响应，其压缩包数据均不完整，且在第二个响应数据包末尾发现Base64 字符串`5pe26Ze057q/5YWz6IGU6Z2e5bi46YeN6KaB`。

将两个压缩包片段依次拼接。

解压密码：`时间线关联非常重要`

FLAG：`flag{a1b2c3d4e5f67890abcdef1234567890-2f4d90a1b7c8e2349d3f56e0a9b01b8a-CBC}`
